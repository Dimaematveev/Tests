...
namespace BankTests
{
    ...
    public class BankAccountTests
    {
        ...
        [TestMethod]
        public void Debit_WhenAmountIsMoreThanBalance_ShouldThrowArgumentOutOfRange_v2()
        {
            // Arrange
            double beginningBalance = 11.99;
        ...
        [TestMethod]
        public void Debit_WhenAmountIsLessThanZero_ShouldThrowArgumentOutOfRange_v2()
        {
            // Arrange
            double beginningBalance = 11.99;
            double debitAmount = -20.0;
